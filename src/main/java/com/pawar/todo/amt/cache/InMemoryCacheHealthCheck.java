...
@Component
public class InMemoryCacheHealthCheck implements HealthCheckCache {

	private final Map<Integer, HealthCheckResponseDto> cache = new ConcurrentHashMap();

	@Override
	public Optional<HealthCheckResponseDto> get(Integer id) {
		return Optional.ofNullable(cache.get(id));
	}

	@Override
	public void put(Integer id, HealthCheckResponseDto dto) {
		if (id != null && dto != null) {
			cache.put(id, dto);
		}
	}
